...
<html lang="en" class="wish-list">
    ...
    <body>
        <header>
            <h1 class="logo"><a href="index.html">Agile Adoption</a></h1>
            <nav">
                <ul class="navList">
                    ...
                    <li><a href="find_pet.html">Find Pet</a></li>           
                </ul>
            </nav>
        </header>
        <main>
        ...
        <footer>
            <nav">
                <ul class="navList">
                    ...
                    <li><a href="about.html">About</a></li>
                    <li><a href="contact_us.html">Contact Us</a></li>
                    <li><a href="wish_list.html">My Wish List</a></li>
                    <li><a href="find_pet.html">Find Pet</a></li>                
                </ul>
            </nav>
            <h1 class="footer-logo"><a href="index.html">Agile <br>Adoption</a></h1>
        </footer>
		<div id="profiles">
		</div>
